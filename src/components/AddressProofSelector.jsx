...
const AddressProofSelector = ({ onSelect, selectedValue, userType = 'jobseeker', placeholder = 'Select address proof' }) => {
  const sheetRef = useRef(null);
  const [searchQuery, setSearchQuery] = useState('');

  const addressProofList = userType === 'recruiter' ? ADDRESS_PROOF_RECRUITER : ADDRESS_PROOF_JOBSEEKER;
