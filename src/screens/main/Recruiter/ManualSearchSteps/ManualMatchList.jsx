...
const ManualMatchList = ({ route, navigation }) => {
  ...
  const renderChips = (items = [], max = 3, chipStyle = styles.chip, textStyle = styles.chipText) => {
          ...
          <View style={styles.rightBadgesRow}>
            ...
            <View style={styles.ratingBadge}>
              ...
              <AppText variant={Variant.caption} style={styles.ratingBadgeText}>
                {item.acceptanceRating}% Acceptance
              </AppText>
            </View>
          </View>
        </View>
  ...
  return (
    <View style={styles.container}>
      <AppHeader
        ...
        onBackPress={() => {
          // If coming from job post, navigate to home instead of going back to posting steps
          if (fromJobPost) {
        ...
        // rightComponent={
        //   <TouchableOpacity
        //     onPress={() => navigation.navigate(screenNames.MANUAL_OFFERS)}
        //   >
...
export default ManualMatchList;
