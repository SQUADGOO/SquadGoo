        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.quickActionsRow}>
                    <QuickAction onPress={() => {
                        navigation.navigate(screenNames.Tab_NAVIGATION, { screen: screenNames.FIND_STAFF });
                    }
                    } iconLib="Feather" iconName="user-plus" label="Find a Staff" />
                    <QuickAction onPress={() => { 
                        navigation.navigate(screenNames.LABOR_POOL)
                    }} iconLib="Feather" iconName="users" label="View Pools" />
                </View>
                <View style={styles.quickActionsRow}>
                    <QuickAction onPress={() => navigation.navigate(screenNames.ACTIVE_OFFERS)} iconLib="Feather" iconName="file-text" label="Manage Offers" />
                    <QuickAction onPress={
                        () => {
                            navigation.navigate(screenNames.Tab_NAVIGATION, { screen: screenNames.CHAT })
                        }
                    } iconLib="Feather" iconName="send" label="Messages" />
                </View>
