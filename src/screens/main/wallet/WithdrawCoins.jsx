...
const WithdrawCoins = ({ navigation }) => {
  ...
  return (
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      {/* Available Coins */}
      <AppText variant={Variant.title} style={styles.availableCoins}>
        Total available coins: {availableCoins}
      </AppText>
        ...
        <View style={styles.coinSelector}>
          <TextInput
            ...
            onChangeText={(text) => {
              ...
              setWithdrawAmount(Math.min(num, availableCoins))
            }}
          ...
          <View style={styles.coinControls}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <AppText variant={Variant.bodySmall} style={styles.maxButtonText}>
                Max
              </AppText>
            </TouchableOpacity>
          </View>
