...
const PreferredJobs = ({navigation}) => {
  const {data: preferredJobs = []} = usePreferences();
        ...
        {preferredJobs.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <AppText variant={Variant.bodyMedium} style={styles.emptyTitle}>
              No preferred jobs added yet
            </AppText>
            <AppText variant={Variant.caption} style={styles.emptySub}>
              Tap + to create your first preferred job profile. These are
              matched with recruiter offers.
            </AppText>
          </View>
        ) : (
          preferredJobs.map(job => {
            ...
            const salaryDisplay =
              job.expectedPayMin && job.expectedPayMax
            ...
            return (
              <View key={job.id} style={styles.card}>
                ...
                <View style={styles.cardHeader}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate(screenNames.ADD_JOB_STEP1, {
                        mode: 'edit',
                        preferredJob: job,
                      })
                    }
                ...
                <View style={styles.availHeader}>
                  <VectorIcons
                    ...
                    color={colors.primary}
                  />
                  <AppText variant={Variant.caption} style={styles.availTitle}>
                    AVAILABILITY
                  </AppText>
                </View>
